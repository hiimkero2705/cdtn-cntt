...
$orderInfo = "Đặt vé xem phim qua MoMo";
$redirectUrl = "http://localhost/anime/?page=datve";
$ipnUrl = "http://localhost/anime/camon.php";
$extraData = "";


if (!empty($_POST)) {
    $orderId = $_POST["idve"]; // Mã đơn hàng
    $amount = $_POST["tongtien"];
    $tongtien = $amount * 0.95;
    $idphim = $_POST["idphim"];
    $requestId = time() . "";

...
$result_suatchieu = mysqli_query($conn, $sql_suatchieu);

$suatchieu_array = array();
while ($row_suatchieu = mysqli_fetch_array($result_suatchieu)) {
    $suatchieu_array[] = $row_suatchieu;
}
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach ($suatchieu_array as $key => $suatchieu) { ?>
                                            <tr>
                                                <th scope="row">
                                                    <?php echo $suatchieu['IDSuat']; ?>
                                                </th>
                                                <td>
                                                    <?php echo $suatchieu['GioChieu']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $suatchieu['NgayChieu']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $suatchieu['TenPhim']; ?>
                                                </td>
                                                <td>

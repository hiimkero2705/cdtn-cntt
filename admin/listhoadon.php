...
$total_hd = $row_count['total'];

// Số phim trên mỗi trang
$hd_per_page = 10;

// Tính số lượng trang
$total_pages = ceil($total_hd / $hd_per_page);

// Xác định trang hiện tại
$current_page = isset($_GET['page']) ? $_GET['page'] : 1;

// Xác định vị trí bắt đầu của phim trên trang hiện tại
$start_index = ($current_page - 1) * $hd_per_page;
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="index.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Thống
                        kê</a>
                    <a href="listhoadon.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Hóa Đơn</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-square btn-outline-danger m-2 delete-button"
                                                        data-id="<?php echo $hd['IDHoaDon']; ?>"><i
                    ...
                    deleteButtons.forEach(function (button) {
                        button.addEventListener('click', function (event) {
                            ...
                            if (!confirmDelete) {
                                ...
                                var hdID = this.getAttribute('data-id');
                                window.location.href = 'xoahd.php?id=' + hdID; // Redirect to xoave.php with the ID parameter
                            }
                        });
                    });
                });

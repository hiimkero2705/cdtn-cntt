...
$total_phim = $row_count['total'];

// Số phim trên mỗi trang
$phim_per_page = 5;

// Tính số lượng trang
$total_pages = ceil($total_phim / $phim_per_page);

// Xác định trang hiện tại
$current_page = isset($_GET['page']) ? $_GET['page'] : 1;

// Xác định vị trí bắt đầu của phim trên trang hiện tại
$start_index = ($current_page - 1) * $phim_per_page;
...
$sql_phim = "SELECT * FROM Phim JOIN danhmuctheloai ON Phim.IDTheLoai = danhmuctheloai.IDTheLoai
                                ...
                                LIMIT $start_index, $phim_per_page";
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach ($phim_array as $key => $phim) { ?>
                                            <tr>
                                                <th scope="row">
                                                    <?php echo $phim['IDPhim']; ?>
                                                </th>
                                                <td>
                                                    <?php echo $phim['TenPhim']; ?>
                                                </td>
                                                <td>
                                                    <img src="../img/phim/<?php echo $phim['HinhAnh']; ?>"
                                                        alt="Preview Image" style="max-width: 100px; max-height: 100px;">
                                                </td>
                                                <td>
                                                    <?php echo $phim['TenTheLoai']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $phim['Dotuoi']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $phim['DaoDien']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $phim['ThoiLuong']; ?> phút
                                                </td>
                                                <td>
                                                    <a href="chinhsua.php?idPhim=<?php echo $phim['IDPhim']; ?>"
                                                        class="btn btn-square btn-outline-warning m-2"><i
                                                            class="fa fa-wrench"></i></a>
                                                    <a href="xoaphim.php?idPhim=<?php echo $phim['IDPhim']; ?>"
                                                        class="btn btn-square btn-outline-danger m-2"><i

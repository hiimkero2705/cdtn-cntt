...
while ($row = mysqli_fetch_assoc($result_do_tuoi)) {
    $dotuoioption .= "<option value='" . $row['IDDotuoi'] . "'>" . $row['Dotuoi'] . "</option>";
}

// Khởi tạo một mảng để lưu trữ các tùy chọn cho trường select
$options = "";
while ($row = mysqli_fetch_assoc($result_the_loai)) {
    $options .= "<option value='" . $row['IDTheLoai'] . "'>" . $row['TenTheLoai'] . "</option>";
}
                ...
                <div class="row bg-secondary rounded align-items-center justify-content-center mx-0">
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="formFile" class="form-label">Poster Phim</label>
                                <input class="form-control bg-dark" type="file" name="posterPhim"

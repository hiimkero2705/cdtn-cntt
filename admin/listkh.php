...
$total_kh = $row_count['total'];

// Số phim trên mỗi trang
$kh_per_page = 10;

// Tính số lượng trang
$total_pages = ceil($total_kh / $kh_per_page);

// Xác định trang hiện tại
$current_page = isset($_GET['page']) ? $_GET['page'] : 1;

// Xác định vị trí bắt đầu của phim trên trang hiện tại
$start_index = ($current_page - 1) * $kh_per_page;

$sql_kh = "SELECT * FROM khachhang LIMIT $start_index, $kh_per_page";
            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="listhoadon.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Hóa
                        Đơn</a>
                        <a href="listkh.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Khách Hàng</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php foreach ($kh_array as $key => $khachhang) { ?>
                                            <tr>
                                                <th scope="row">
                                                    <?php echo $khachhang['IDKH']; ?>
                                                </th>
                                                <td>
                                                    <?php echo $khachhang['TenKH']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $khachhang['Email']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $khachhang['Password']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $khachhang['bac']; ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>

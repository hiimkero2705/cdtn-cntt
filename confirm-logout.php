<div id="teko-modal-lobnnt52wasr7bbnvon"
        ...
        <div class="teko-modal teko-modal-show css-t2ptn2" style="opacity: 1; transform: translateY(0px);">
            <div class="teko-modal-content"><svg fill="none" viewBox="0 0 24 24" class="teko-modal-close css-1qzn8fv"
                ...
                <div class="teko-modal-header">
                    <div type="title" class="teko-modal-title css-1cp1h79">Đăng xuất</div>
                </div>
                <div class="teko-modal-body">
                    <div>Bạn có chắc chắn muốn đăng xuất không?</div>
                    <div class="teko-modal-footer teko-modal-footer-right">
                        <button onclick="window.history.back(-1);" height="2.5rem" class="css-12b53wj" type="button">
                            <div type="body" class="button-text css-1lchwqw">Không</div>
                            <span style="margin-left: 0px;">
                                <div class="css-157jl91"></div>
                            </span>
                        </button>
                        <button onclick="window.location.href='logout.php';" name="yes" height="2.5rem" color="white"
                            class="css-fhio94" type="button">
                            <div type="body" class="button-text css-2h64mz" color="white">Có</div>
                            <span style="margin-left: 0px;">
                                <div class="css-157jl91"></div>
                            </span>
                        </button>
